...
export type ProjectsScrollHandle = {
  reveal: () => void
}
    ...
    */
    ...
    useEffect(() => {
      ...
      const ctx = gsap.context(() => {
        ...
        const sectionProgresses = Array.from(
      ...
      */
        ...
        function handleTexts(nextIndex: number) {
          ...
          const lettersOut =
            wordsRefs.current[activeIndex]?.filter(Boolean) ?? []
    ...
    const handleArchiveClick = useCallback(
      (e: React.MouseEvent) => {
        ...
        const to = "polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)"
    ...
    return (
      <div
        ...
        className={cn(
          ...
          !show && "opacity-0",
          (!show || isHidden) && "pointer-events-none",
        )}
      >
        {/* BACKGROUNDS */}
...
ProjectsScroll.displayName = "ProjectsScroll"
